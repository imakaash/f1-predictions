"""Predict the upcoming Monaco GP podium.
...
proxy. At Monaco, qualifying position is the single strongest feature —
overtaking is nearly impossible, so passing real quali data is especially
valuable here.
